jQuery(document).ready(function () {
  jQuery(".twbb-pu-upgrade-close, .twbb-pu-upgrade-layout").on(
    "click",
    function () {
      jQuery(".twbb-pu-upgrade-layout, .twbb-pu-upgrade-container").addClass(
        "twbb-pu-hidden"
      );
  ...
  jQuery(".twbb-pu-upgrade-videos li.twbb-pu-video-item").on(
    "click",
    function () {
...
function twbb_pu_run_video(that) {
  ...
  jQuery(that)
    .find("svg circle")
    .css("animation", "countdown " + duration + "s linear infinite forwards");
