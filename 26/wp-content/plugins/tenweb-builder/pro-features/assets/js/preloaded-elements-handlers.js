...
(self["webpackChunkelementor_tenweb"] =
  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class CarouselBase extends elementorModules.frontend.handlers
          .SwiperBase {
          getDefaultSettings() {
            return {
              selectors: {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class _default extends elementorModules.Module {
          constructor() {
            ...
            elementorFrontend.elementsHandler.attachHandler("twbb_form", [
              ...formHandlers,
              _recaptcha.default,
              _date.default,
              _time.default,
  ...
  \***********************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class DataTimeFieldBase extends elementorModules.frontend.handlers
          .Base {
          getDefaultSettings() {
            return {
              selectors: {
        ...
        class FormSteps extends elementorModules.frontend.handlers.Base {
          ...
          updateIndicatorsState(direction) {
            ...
            this.elements.$currentIndicator
              ...
              .addClass(indicatorsClasses.next.add); // Updating an indicator svg fill color, if loaded inside an object tag.
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class galleryHandler extends elementorModules.frontend.handlers.Base {
          ...
          getDefaultElements() {
            ...
            elements.$images = elements.$items
              .children(selectors.twbbGalleryImageDiv)
              .children(selectors.galleryImages);
            elements.$itemsOverlay = elements.$items
              .children(selectors.twbbGalleryImageDiv)
              .children(selectors.galleryItemOverlay);
          ...
          getSettingsDictionary() {
            ...
            activeBreakpointsKeys.forEach((breakpoint) => {
              ...
              settingsDictionary["hgap_" + breakpoint] = [
                "breakpoints." +
                  activeBreakpoints[breakpoint].value +
                  ".horizontalGap",
              ];
              ...
              lastFrame =
                0 === this.lottie.__initialFirstFrame
                  ...
                  : this.lottie.__initialFirstFrame +
                    this.lottie.__initialTotalFrames; // Limiting min start point to animation first frame.
  ...
  \*******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _default = elementorModules.frontend.handlers.Base.extend({
          ...
          onInit() {
            this.menuHeightController =
              new elementorTenwebFrontend.utils.DropdownMenuHeightController(
          ...
          showModal(avoidMultiple, event) {
            ...
            if (!this.isEdit) {
              if (!elementorFrontend.isWPPreviewMode()) {
                ...
                if (
                  avoidMultiple &&
                  elementorTenwebFrontend.modules.popup.popupPopped &&
        ...
        class _default extends elementorModules.Module {
          ...
          onFrontendComponentsInit() {
            elementorFrontend.utils.urlActions.addAction(
              "popup:open",
              (settings) => this.showPopup(settings)
            );
            elementorFrontend.utils.urlActions.addAction(
              "popup:close",
        ...
        var _default = elementorModules.frontend.handlers.Base.extend({
          ...
          handleFormAction(event, response) {
            ...
            if ("open" === popupSettings.action) {
              return elementorTenwebFrontend.modules.popup.showPopup(
                popupSettings
              );
            }

            setTimeout(() => {
              return elementorTenwebFrontend.modules.popup.closePopup(
                popupSettings,
                event
              );
            }, 1000);
        ...
        class LoadMore extends elementorModules.frontend.handlers.Base {
          ...
          onInit() {
            ...
            this.isInfinteScroll =
              "load_more_infinite_scroll" === paginationType; // When spinner is not available, the button's text should not be hidden.
        ...
        var _default = elementorModules.frontend.handlers.Base.extend({
          ...
          setColsCountSettings() {
            const settings = this.getElementSettings(),
              ...
              colsCount =
                elementorTenwebFrontend.utils.controls.getResponsiveControlValue(
                  settings,
                  `${skinPrefix}columns`
                );
