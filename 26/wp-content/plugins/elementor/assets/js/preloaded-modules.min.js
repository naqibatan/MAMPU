      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        setSlideshowContent(e) {
          ...
          p.onShow = async () => {
            ...
            i || (t.navigation = { prevEl: u[0], nextEl: m[0] }),
        ...
        playSlideVideo() {
          ...
          const s = this.getSettings("classes"),
            ...
            o = jQuery("<div>", {
              class: `${s.videoWrapper} elementor-video-${this.getRatioType(
                i
              )}`,
          ...
          n.append(o),
            ...
            -1 !== t.indexOf("vimeo.com")
              ? ((a = "vimeo"), (l = elementorFrontend.utils.vimeo))
              : t.match(
                  /^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/
                ) && ((a = "youtube"), (l = elementorFrontend.utils.youtube));
          const d = l.getVideoIDFromURL(t);
          l.onApiReady((e) => {
            "youtube" === a
              ? this.prepareYTVideo(e, d, n, o, r)
              : "vimeo" === a && this.prepareVimeoVideo(e, t, n, o, r);
          }),
