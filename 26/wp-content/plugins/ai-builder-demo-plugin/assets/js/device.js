    ...
    setTimeout(function () {
      ...
      jQuery("body").append(
        "<div class='tbdemo-device-layer' style='display: none'></div><iframe src='" +
          url +
          "' id='tbdemo-device-iframe'  style='display: none;'></iframe>"
      );
      ...
      jQuery(document).on("click", ".tbdemo-device-mobile", function () {
        ...
        if (
          typeof tbdemo_fake_editor_marker == "function" &&
